            ...
            <div class="pull-left">
                <div>
                    <div class="input-append">
                        <label>* <spring:message code="books.name"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="text"
                               required
                ...
                <div>
                    <div class="input-append">
                        <label>* <spring:message code="books.author"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="text"
                               required
                               ng-model="book.bookAuthor"
                               name="bookAuthor"
                               />
                    </div>
                    <div class="input-append">
                ...
                <div>
                    <div class="input-append">
                        <label>* <spring:message code="books.cost"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="text"
                               required
...
<div id="updateBooksModal"
     class="modal hide fade in centering insertAndUpdateDialogs"
     role="dialog"
     aria-labelledby="updateBooksModalLabel"
     aria-hidden="true">
    <div class="modal-header">
        <h3 id="updateBooksModalLabel" class="displayInLine">
            <spring:message code="update"/>&nbsp;<spring:message code="book"/>
        </h3>
    </div>
    <div class="modal-body">
        <form name="updateBookForm" novalidate>
            ...
            <div class="pull-left">
                ...
                <button class="btn btn-inverse"
                        data-dismiss="modal"
                        ng-click="exit('#updateBooksModal');"
                        aria-hidden="true">
...
<div id="deleteBooksModal"
     class="modal hide fade in centering"
     role="dialog"
     aria-labelledby="searchBooksModalLabel"
     aria-hidden="true">
    <div class="modal-header">
        <h3 id="deleteBooksModalLabel" class="displayInLine">
            <spring:message code="delete"/>&nbsp;<spring:message code="book"/>
        </h3>
    </div>
    <div class="modal-body">
        <form name="deleteBookForm" novalidate>
            <p><spring:message code="delete.confirm"/>:&nbsp;{{book.bookName}}?</p>
            ...
            <button class="btn btn-inverse"
                    data-dismiss="modal"
                    ng-click="exit('#deleteBooksModal');"
                    aria-hidden="true">
                <spring:message code="cancel"/>
            </button>
        </form>
